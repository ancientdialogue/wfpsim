...
const file_protos_model_enums_proto_rawDesc = "" +
	"\n" +
	"\x18protos/model/enums.proto\x12\x05model*\x8b\x01\n" +
	"\x0fAvatarCurveType\x12\x18\n" +
	"\x14INVALID_AVATAR_CURVE\x10\x00\x12\x14\n" +
	"\x10GROW_CURVE_HP_S4\x10\x01\x12\x18\n" +
	"\x14GROW_CURVE_ATTACK_S4\x10\x02\x12\x14\n" +
	"\x10GROW_CURVE_HP_S5\x10\x03\x12\x18\n" +
	"\x14GROW_CURVE_ATTACK_S5\x10\x04*f\n" +
	"\vQualityType\x12\x18\n" +
	"\x14INVALID_QUALITY_TYPE\x10\x00\x12\x15\n" +
	"\x11QUALITY_ORANGE_SP\x10\x06\x12\x12\n" +
	"\x0eQUALITY_ORANGE\x10\x05\x12\x12\n" +
	"\x0eQUALITY_PURPLE\x10\x04*\x97\x04\n" +
	"\x0fWeaponCurveType\x12\x18\n" +
	"\x14INVALID_WEAPON_CURVE\x10\x00\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_101\x10\x01\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_102\x10\x02\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_103\x10\x03\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_104\x10\x04\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_105\x10\x05\x12\x1b\n" +
	"\x17GROW_CURVE_CRITICAL_101\x10\x06\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_201\x10\a\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_202\x10\b\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_203\x10\t\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_204\x10\n" +
	"\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_205\x10\v\x12\x1b\n" +
	"\x17GROW_CURVE_CRITICAL_201\x10\f\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_301\x10\r\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_302\x10\x0e\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_303\x10\x0f\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_304\x10\x10\x12\x19\n" +
	"\x15GROW_CURVE_ATTACK_305\x10\x11\x12\x1b\n" +
	"\x17GROW_CURVE_CRITICAL_301\x10\x12*\x8d\x01\n" +
	"\vWeaponClass\x12\x18\n" +
	"\x14INVALID_WEAPON_CLASS\x10\x00\x12\x19\n" +
	"\x15WEAPON_SWORD_ONE_HAND\x10\x01\x12\x13\n" +
	"\x0fWEAPON_CLAYMORE\x10\x02\x12\x0f\n" +
	"\vWEAPON_POLE\x10\x03\x12\x0e\n" +
	"\n" +
	"WEAPON_BOW\x10\x04\x12\x13\n" +
	"\x0fWEAPON_CATALYST\x10\x05*t\n" +
	"\x10MonsterCurveType\x12\x19\n" +
	"\x15INVALID_MONSTER_CURVE\x10\x00\x12\x11\n" +
	"\rGROW_CURVE_HP\x10\x01\x12\x13\n" +
	"\x0fGROW_CURVE_HP_2\x10\x02\x12\x1d\n" +
	"\x19GROW_CURVE_HP_ENVIRONMENT\x10\x03*}\n" +
	"\bBodyType\x12\x15\n" +
	"\x11INVALID_BODY_TYPE\x10\x00\x12\x10\n" +
	"\fBODY_UNKNOWN\x10\x01\x12\f\n" +
	"\bBODY_BOY\x10\x02\x12\r\n" +
	...
	"\x14ASSOC_TYPE_MONDSTADT\x10\x02\x12\x14\n" +
	"\x10ASSOC_TYPE_LIYUE\x10\x03\x12\x16\n" +
	"\x12ASSOC_TYPE_INAZUMA\x10\x04\x12\x15\n" +
	"\x11ASSOC_TYPE_SUMERU\x10\x05\x12\x14\n" +
	"\x10ASSOC_TYPE_FATUI\x10\x06\x12\x15\n" +
	"\x11ASSOC_TYPE_RANGER\x10\a\x12\x18\n" +
	"\x14ASSOC_TYPE_MAINACTOR\x10\b\x12\x17\n" +
	"\x13ASSOC_TYPE_FONTAINE\x10\t\x12\x15\n" +
	...
	"\x04Fire\x10\x02\x12\a\n" +
	"\x03Ice\x10\x03\x12\t\n" +
	"\x05Water\x10\x04\x12\t\n" +
	"\x05Grass\x10\x05\x12\x13\n" +
	"\x0fELEMENT_QUICKEN\x10\x06\x12\x12\n" +
	"\x0eELEMENT_FROZEN\x10\a\x12\b\n" +
	"\x04Wind\x10\b\x12\b\n" +
	"\x04Rock\x10\t\x12\x10\n" +
	"\fELEMENT_NONE\x10\n" +
	"\x12\x14\n" +
	"\x10ELEMENT_PHYSICAL\x10\v\x12\x13\n" +
	"\x0fELEMENT_UNKNOWN\x10\f*\xf8\x05\n" +
	"\bStatType\x12\x15\n" +
	"\x11INVALID_STAT_TYPE\x10\x00\x12\x1e\n" +
	"\x1aFIGHT_PROP_DEFENSE_PERCENT\x10\x01\x12\x16\n" +
	"\x12FIGHT_PROP_DEFENSE\x10\x02\x12\x11\n" +
	"\rFIGHT_PROP_HP\x10\x03\x12\x19\n" +
	"\x15FIGHT_PROP_HP_PERCENT\x10\x04\x12\x15\n" +
	"\x11FIGHT_PROP_ATTACK\x10\x05\x12\x1d\n" +
	"\x19FIGHT_PROP_ATTACK_PERCENT\x10\x06\x12 \n" +
	"\x1cFIGHT_PROP_CHARGE_EFFICIENCY\x10\a\x12\x1e\n" +
	"\x1aFIGHT_PROP_ELEMENT_MASTERY\x10\b\x12\x17\n" +
	"\x13FIGHT_PROP_CRITICAL\x10\t\x12\x1c\n" +
	"\x18FIGHT_PROP_CRITICAL_HURT\x10\n" +
	"\x12\x17\n" +
	"\x13FIGHT_PROP_HEAL_ADD\x10\v\x12\x1c\n" +
	"\x18FIGHT_PROP_FIRE_ADD_HURT\x10\f\x12\x1d\n" +
	"\x19FIGHT_PROP_WATER_ADD_HURT\x10\r\x12\x1d\n" +
	"\x19FIGHT_PROP_GRASS_ADD_HURT\x10\x0e\x12\x1c\n" +
	"\x18FIGHT_PROP_ELEC_ADD_HURT\x10\x0f\x12\x1c\n" +
	"\x18FIGHT_PROP_WIND_ADD_HURT\x10\x10\x12\x1b\n" +
	"\x17FIGHT_PROP_ICE_ADD_HURT\x10\x11\x12\x1c\n" +
	"\x18FIGHT_PROP_ROCK_ADD_HURT\x10\x12\x12 \n" +
	"\x1cFIGHT_PROP_PHYSICAL_ADD_HURT\x10\x13\x12/\n" +
	"+FIGHT_PROP_SHIELD_COST_MINUS_RATIO_ADD_HURT\x10\x14\x12\x19\n" +
	"\x15FIGHT_PROP_HEALED_ADD\x10\x15\x12\x16\n" +
	"\x12FIGHT_PROP_BASE_HP\x10\x16\x12\x1a\n" +
	"\x16FIGHT_PROP_BASE_ATTACK\x10\x17\x12\x1b\n" +
	"\x17FIGHT_PROP_BASE_DEFENSE\x10\x18\x12\x15\n" +
	"\x11FIGHT_PROP_MAX_HP\x10\x19*@\n" +
	"\aSimMode\x12\x14\n" +
	...
	"\x17DB_TAG_ADMIN_DO_NOT_USE\x10\xff\xc1\xd7/\"\x04\b\x03\x10\x03\"\x04\b\x04\x10\x04*{\n" +
	"\tEquipType\x12\x16\n" +
	"\x12INVALID_EQUIP_TYPE\x10\x00\x12\x10\n" +
	"\fEQUIP_BRACER\x10\x01\x12\x12\n" +
	"\x0eEQUIP_NECKLACE\x10\x02\x12\x0f\n" +
	"\vEQUIP_SHOES\x10\x03\x12\x0e\n" +
	"\n" +
	"EQUIP_RING\x10\x04\x12\x0f\n" +
	"\vEQUIP_DRESS\x10\x05B'Z%github.com/genshinsim/gcsim/pkg/modelb\x06proto3"
...
var file_protos_model_enums_proto_enumTypes = make([]protoimpl.EnumInfo, 13)
