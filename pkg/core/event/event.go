...
const (
	...
	OnAimShoot     // nil
	OnDash
	OnLunarReactionAttack // target, AttackEvent, owner; event so predamagemods can be applied to the individual Lunar contributions. Emitted once per contributor
