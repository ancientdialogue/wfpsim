...
var (
	attackFrames   [][]int
	attackHitmarks = [][]int{{10}, {15, 24}, {40}}
)
...
func init() {
	...
	attackFrames[1] = frames.InitNormalCancelSlice(attackHitmarks[1][1], 33)
	attackFrames[2] = frames.InitNormalCancelSlice(attackHitmarks[2][0], 63)
}
