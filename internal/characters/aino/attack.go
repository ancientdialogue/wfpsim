...
func init() {
	...
	attackFrames[0] = frames.InitNormalCancelSlice(attackHitmarks[0][0], 48) // N1 -> N2
	attackFrames[0][action.ActionAttack] = 32
	attackFrames[1] = frames.InitNormalCancelSlice(attackHitmarks[1][0], 75) // N2 -> N3
	attackFrames[1][action.ActionAttack] = 43
	attackFrames[2] = frames.InitNormalCancelSlice(attackHitmarks[2][1], 93) // N3 -> N1
